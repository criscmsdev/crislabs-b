...
import { HardwareStorePage1 } from 'src/common/entities/page.model';
import { PageDocument } from 'src/common/entities/page.schema';
import { ListInput } from 'src/common/pagination/dto/list.input';
import { HardwareStorePages1Repository } from '../hardware-store-pages.repository';

@Injectable()
export class HardwareStorePages1Service {
  constructor(private readonly pageRepository: HardwareStorePages1Repository) {}
  ...
  private toModel({
    ...
    parentId,
    slug,
  }: PageDocument): HardwareStorePage1 {
    return {
      _id: _id.toHexString(),
      dataPage: dataPage,
      siteId: siteId,
