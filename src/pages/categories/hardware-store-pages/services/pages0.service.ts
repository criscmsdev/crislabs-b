...
import { HardwareStorePages0Repository } from '../hardware-store-pages.repository';

@Injectable()
export class HardwareStorePages0Service {
  constructor(private readonly pageRepository: HardwareStorePages0Repository) {}
  ...
  private toModel({
    ...
    parentId,
    slug,
  }: PageDocument): HardwareStorePage0 {
    return {
      _id: _id.toHexString(),
      dataPage: dataPage,
      siteId: siteId,
