...
import { HardwareStorePage3 } from 'src/common/entities/page.model';
import { PageDocument } from 'src/common/entities/page.schema';
import { ListInput } from 'src/common/pagination/dto/list.input';
import { HardwareStorePages3Repository } from '../hardware-store-pages.repository';

@Injectable()
export class HardwareStorePages3Service {
  constructor(private readonly pageRepository: HardwareStorePages3Repository) {}
  ...
  private toModel({
    ...
    parentId,
    slug,
  }: PageDocument): HardwareStorePage3 {
    return {
      _id: _id.toHexString(),
      dataPage: dataPage,
      siteId: siteId,
