...
import { WearPage1 } from 'src/common/entities/page.model';
import { PageDocument } from 'src/common/entities/page.schema';
import { ListInput } from 'src/common/pagination/dto/list.input';
import { WearPages1Repository } from '../wear-pages.repository';

@Injectable()
export class WearPages1Service {
  constructor(private readonly pageRepository: WearPages1Repository) {}
