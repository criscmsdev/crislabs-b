...
import { WearPage2 } from 'src/common/entities/page.model';
import { PageDocument } from 'src/common/entities/page.schema';
import { ListInput } from 'src/common/pagination/dto/list.input';
import { WearPages2Repository } from '../wear-pages.repository';

@Injectable()
export class WearPages2Service {
  constructor(private readonly pageRepository: WearPages2Repository) {}
