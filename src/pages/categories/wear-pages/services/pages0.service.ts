...
import { WearPage0 } from 'src/common/entities/page.model';
import { PageDocument } from 'src/common/entities/page.schema';
import { ListInput } from 'src/common/pagination/dto/list.input';
import { WearPages0Repository } from '../wear-pages.repository';

@Injectable()
export class WearPages0Service {
  constructor(private readonly pageRepository: WearPages0Repository) {}
  ...
  async deletePagesByParentId(ids: string[]) {
    await this.pageRepository.deleteMany({ parentId: { $in: ids } });
    return ids;
  }
