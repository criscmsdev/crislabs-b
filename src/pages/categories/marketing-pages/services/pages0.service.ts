...
import { MarketingPage0 } from 'src/common/entities/page.model';
import { PageDocument } from 'src/common/entities/page.schema';
import { ListInput } from 'src/common/pagination/dto/list.input';
import { MarketingPages0Repository } from '../marketing-pages.repository';

@Injectable()
export class MarketingPages0Service {
  constructor(private readonly pageRepository: MarketingPages0Repository) {}
