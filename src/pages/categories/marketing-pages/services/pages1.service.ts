...
import { MarketingPage1 } from 'src/common/entities/page.model';
import { PageDocument } from 'src/common/entities/page.schema';
import { ListInput } from 'src/common/pagination/dto/list.input';
import { MarketingPages1Repository } from '../marketing-pages.repository';

@Injectable()
export class MarketingPages1Service {
  constructor(private readonly pageRepository: MarketingPages1Repository) {}
